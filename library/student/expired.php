...
<br><br><br><br>
        ...
        $sql="SELECT student.email,roll,books.ID,bookname,authors,edition,approve,issue,issue_book.return FROM student inner join issue_book ON student.email=issue_book.email inner join books ON issue_book.bid=books.ID WHERE issue_book.approve ='$ret' and issue_book.username ='$_SESSION[login_user]'  ORDER BY `issue_book`.`return` DESC";
        ...
        {
        $sql="SELECT student.email,roll,books.ID,bookname,authors,edition,approve,issue,issue_book.return FROM student inner join issue_book ON student.email=issue_book.email inner join books ON issue_book.ID=books.ID WHERE issue_book.approve !='' and issue_book.approve !='Yes'  and issue_book.email ='$_SESSION[login_user]' ORDER BY `issue_book`.`return` DESC";
        $res=mysqli_query($db,$sql);
        }
