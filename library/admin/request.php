...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT student.email,roll,books.ID,Bookname,Authors,Edition,status FROM student inner join issue_book ON student.email=issue_book.email inner join books ON issue_book.ID=books.ID WHERE issue_book.approve =''";
